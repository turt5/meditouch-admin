...
class CustomImagePicker extends ConsumerWidget {
  ...
  Future<void> _pickImage(WidgetRef ref) async {
    ...
    uploadInput.onChange.listen((e) async {
      ...
      reader.onLoadEnd.listen((e) {
        ...
        ref.read(addNurseViewModelProvider).setImage=file; // Assuming your provider can accept an html.File
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final imageState = ref.watch(addNurseViewModelProvider).getImage;
